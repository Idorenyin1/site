...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="https://ff.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=FuOO6G-C-fVIl6wAlKZsvRJMKi54oaAr1VDOn2y202u9IhKdoLiFFj8Nvos-VH3Cxvvf3B0ADUJvQhxbffDCvJfdCTB3G3dLHd8N898loSs" charset="UTF-8"></script><script type='text/javascript' src='js/jquery-3.3.1.js'></script>
...
<div class="cabContent">
    <span class="secCap">Dashboard</span>
    <div class="userAcc">
        <div class="grid">
            <div class="item col6">
                    ...
                    <div class="in">
                        <div class="cabTitle">
                            <div class="iconLeft">
                                ...
                                <div class="data">
                                    <span class="title">john2020</span>
                                </div>
                            </div>
                        </div>
                        <br>
                        <br>
                        <p>Welcome john2020, this is your personal dashboard, you will receive notification from management here</p>                         
                    </div>
                </div>
            </div>
            <div class="item col6">
                <div class="contentItem">
                    <div class="in">
                        ...
                        <div class="inBlockType2">
                            <div class="inWrap">
                                <input type="text" class="copyLink" id="refLink" data-clipboard-target="#refLink" value="https://www.Crypto303options.com/?ref=">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="contentItem">
                    <div class="in">
                        ...
                        <ul class="cabTbl1 table full in">
                            <li class="tRow">
                                <span class="param tCell middle">Current Earnings</span>
                                <span class="tCell data middle right">$0.00</span>
                            </li>
                            <li class="tRow">
                                <span class="param tCell middle">Last Trade Profit</span>
                                <span class="tCell data middle right">$0.00</span>
                            </li>
                            <li class="tRow">
                                <span class="param tCell middle">Investment Plan</span>
                                <span class="tCell data middle right">
                                    Basic</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="contentItem">
                    <div class="in">
                        ...
                        <ul class="cabTbl1 table full out">
                            <li class="tRow">
                                <span class="param tCell middle">Earned toral</span>
                                <span class="tCell data middle right">$0.00</span>
                            </li>
                            <li class="tRow">
                                <span class="param tCell middle">Pending withdrawal</span>
                                <span class="tCell data middle right">$0.00</span>
                            </li>
                            <li class="tRow">
                                <span class="param tCell middle">Withdrew total</span>
                                <span class="tCell data middle right">$0.00</span>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="item col6">
                <div class="contentItem">
                    <div class="in">
                        ...
                        <div class="upline">
                            <div class="iconLeft">
                                <div class="icon userpic" style="background-image: url(https://i-forex.biz/img/user_2.png)"></div>
                                <div class="data">
                                      <a>Personal manager</a>
                                      <a>support@Crypto303options.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
